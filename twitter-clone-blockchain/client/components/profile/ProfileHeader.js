...
const style ={
    ...
    coverPhotoContainer: 'flex item-center justify-center h-[15vh] overflow-hidden ',
  ...
  return (
    <div className={style.wrapper}>
        ...
        <div className={style.coverPhotoContainer}>
            <img src="https://i.imgur.com/xyjncym.jpg" 
                alt='cover image' 
        ...
        <div className={style.profileImageContainer}>
            <div className={isProfileImageNft ? 'hex' : style.profileImageContainer}>
                <img src='https://i.imgur.com/foXaJLg.png' alt='Riyansh' className={ isProfileImageNft ? style.profileImageNft : style.profileImage} />
            </div>
        </div>
        <div className={style.details}>
            <div>
